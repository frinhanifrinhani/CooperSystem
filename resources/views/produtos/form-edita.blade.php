                ...
                <div class="container col-md-10">
                    <form action="/produto/atualizar" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="valor_unitario" value="{{ $produto->valor_unitario }}"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Quantidade em Estoque</label>
                            <input name="quantidade_estoque" value="{{ $produto->quantidade_estoque }}" type="number" class="form-control">
                        </div>
